...
export const clientEnv = createEnv({
  ...
  client: {
    ...
    VITE_STRIPE_PRICE_STUDIO_MONTHLY: z.string().optional(),
    VITE_STRIPE_PRICE_STUDIO_YEARLY: z.string().optional(),
    ...
    VITE_CREEM_PRODUCT_STUDIO_MONTHLY: z.string().optional(),
    VITE_CREEM_PRODUCT_STUDIO_YEARLY: z.string().optional(),
