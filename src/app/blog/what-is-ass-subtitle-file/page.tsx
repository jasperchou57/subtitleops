    ...
    <article className="mx-auto max-w-3xl px-4 sm:px-6 py-16">
      ...
      <header className="mb-10">
        ...
        <p className="mt-4 text-muted-foreground leading-relaxed">
          An ASS subtitle file is an Advanced SubStation Alpha file. Unlike SRT, ASS can store fonts, colors,
          outlines, screen positioning, animation tags, and karaoke timing. It is commonly used for fansubs,
          lyric videos, sign translations, and any project where subtitle appearance matters.
        </p>
      </header>
      ...
      <div className="mb-10 flex items-start gap-3 rounded-xl border border-blue-200 bg-blue-50/50 p-4">
        ...
        <p className="text-sm">
          <span className="font-medium text-foreground">Need a simpler subtitle file?</span>{" "}
          ...
          <Link href="/tools/srt-to-ass" title="Convert SRT to ASS subtitle format" className="font-medium text-blue-600 underline underline-offset-4 hover:text-blue-800">convert SRT to ASS</Link>{" "}
      ...
      <section className="mb-10">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed mb-4">
          ASS files are structured into sections. The key sections are script metadata, style definitions, and timed
          dialogue events. That structure lets one file carry both the subtitle text and the visual rules for how the
      ...
      <section className="mb-10">
        ...
        <ul className="space-y-3 text-sm text-muted-foreground">
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0 w-44">Styled subtitles:</span>
            Keep ASS if the file uses colors, font choices, outlines, shadows, or named styles that matter to the video.
          </li>
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0 w-44">Screen positioning:</span>
            Keep ASS when lines need to avoid on-screen text, signs, graphics, or speaker labels.
          </li>
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0 w-44">Karaoke timing:</span>
            Keep ASS when syllable-level timing or animated lyric effects are part of the subtitle work.
          </li>
        </ul>
      </section>

      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4">When Should You Convert ASS to SRT?</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
          Convert ASS to SRT when compatibility matters more than styling. SRT works across more players, editors,
          transcription tools, and upload forms. The tradeoff is that SRT cannot preserve ASS-only features such as
          positioning, animation tags, karaoke effects, and most style definitions.
        </p>
      </section>
