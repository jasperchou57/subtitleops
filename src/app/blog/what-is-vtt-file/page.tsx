    ...
    <article className="mx-auto max-w-3xl px-4 sm:px-6 py-16">
      ...
      <header className="mb-10">
        ...
        <p className="mt-4 text-muted-foreground leading-relaxed">
          A VTT file is a WebVTT caption file used by HTML5 video players to display timed text in the browser.
          It looks similar to SRT, but WebVTT adds a required header, browser-oriented cue settings, comments, and
      ...
      <div className="mb-10 flex items-start gap-3 rounded-xl border border-blue-200 bg-blue-50/50 p-4">
        ...
        <p className="text-sm">
          <span className="font-medium text-foreground">Need to move between VTT and SRT?</span>{" "}
      ...
      <section className="mb-10">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed mb-4">
          A valid VTT file starts with the <code className="bg-muted px-1.5 py-0.5 rounded text-xs">WEBVTT</code>{" "}
          header. Each cue then uses dot-based timestamps and visible caption text.
        </p>
...
Open the file menu.`}
        ...
        <ul className="space-y-3 text-sm text-muted-foreground">
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0 w-40">Header:</span>
            VTT requires a WEBVTT header. SRT does not have one.
          </li>
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0 w-40">Timestamps:</span>
            VTT uses dots before milliseconds, such as <code className="bg-muted px-1.5 py-0.5 rounded text-xs">00:00:01.000</code>.
          </li>
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0 w-40">Cue settings:</span>
            Settings such as align, line, size, and position can tell the browser how to place a cue.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed mb-4">
          Use VTT when the subtitle file is meant for a website, a course platform, or any HTML5 video workflow.
          The browser <code className="bg-muted px-1.5 py-0.5 rounded text-xs">&lt;track&gt;</code> element expects WebVTT,
          not SRT. This is why an SRT file often needs to be converted before it can power native browser captions.
        </p>
        <p className="text-sm text-muted-foreground leading-relaxed">
          Use SRT when you need maximum compatibility with desktop media players, subtitle editors, video editors, and
          transcription tools. VTT is the better web delivery format; SRT is still the better interchange format for many
          editing workflows.
        </p>
      </section>
          ...
          <table className="w-full text-sm border">
            ...
            <tbody className="text-muted-foreground">
              <tr className="border-b">
                <td className="p-3 font-medium text-foreground">Browser video</td>
              ...
              <tr className="border-b">
                <td className="p-3 font-medium text-foreground">Milliseconds</td>
                <td className="p-3">Dot</td>
                <td className="p-3">Comma</td>
              </tr>
              <tr>
                <td className="p-3 font-medium text-foreground">Cue placement</td>
