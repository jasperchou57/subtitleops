  ...
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6">
      ...
      <section className="pb-12 border-t pt-10">
        <h2 className="text-2xl font-bold mb-4">What Is an SBV to SRT Converter?</h2>
        <p className="text-sm text-muted-foreground leading-relaxed mb-5">
          An SBV to SRT converter turns YouTube-style SBV captions into SubRip subtitles by rewriting comma-separated
          SBV timestamp pairs into SRT arrow timestamps, adding numbered cues, and preserving the original caption text.
          This makes YouTube caption exports easier to edit, archive, and reuse in tools that expect .srt files.
        </p>
