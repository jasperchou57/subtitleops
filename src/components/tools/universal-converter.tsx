...
import {
  ...
  formatLabels,
  type SubtitleFormat,
} from '@/lib/converters/detect-format';
...
export function UniversalConverter() {
  ...
  const availableOutputs = inputFormat
    ? getAvailableOutputFormats(inputFormat)
    : [];

  return (
    <div
      data-analytics-area="universal_converter"
      data-analytics-tool="universal"
      ...
      {!file ? (
        ...
        >
          ...
          <p className="text-base font-medium">
            {isDragOver
              ? 'Drop your file here'
              : 'Upload or drop a subtitle file'}
          </p>
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-muted-foreground">
                Detected as{' '}
                {inputFormat ? formatLabels[inputFormat] : 'unknown'}
              </p>
            </div>
            <button
              type="button"
                ...
                <div className="grid md:grid-cols-2 gap-4 mb-5">
                  <div>
                    <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-2">
                      Original ({inputFormat?.toUpperCase()})
                    </p>
                    <pre className="rounded-lg bg-muted/50 p-3 text-xs leading-relaxed overflow-auto max-h-40 font-mono">
