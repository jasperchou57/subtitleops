    ...
    <div className="responsive-content mx-auto max-w-4xl px-4 sm:px-6">
      ...
      <section className="pb-12 border-t pt-10">
        <h2 className="text-2xl font-bold mb-4">
          What Is Subtitle Timing Shift?
        </h2>
        <p className="text-sm text-muted-foreground leading-relaxed mb-5">
          Subtitle timing shift moves every cue in a subtitle file by the same
          fixed offset. It is the right fix when subtitles are consistently
          early or late for the entire video. If the first subtitle is two
          seconds late and the last subtitle is also two seconds late, a -2
          second shift will realign the whole file.
        </p>
        <div className="rounded-xl border bg-card p-5 text-sm text-muted-foreground">
          ...
          <p>
            ...
            <span className="font-mono">-2</span> second shift. Every other cue
        ...
        <ol className="grid gap-4 md:grid-cols-3 mb-8">
          <li className="rounded-lg border bg-card p-5">
            ...
            <p className="text-sm text-muted-foreground">
              Start with the subtitle file you need to re-sync. The tool detects
              SRT and VTT automatically by extension and content, and runs the
              entire shift locally so nothing is uploaded.
            </p>
          </li>
          <li className="rounded-lg border bg-card p-5">
            <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-foreground text-background text-sm font-bold mb-3">
            ...
            <p className="text-sm text-muted-foreground">
              Type the number of seconds you need to move the subtitles.
              Positive values push cues later, negative values pull them
              earlier. Decimal values are supported, so you can shift by
              fractional amounts like 1.25 seconds.
            </p>
          </li>
          <li className="rounded-lg border bg-card p-5">
            <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-foreground text-background text-sm font-bold mb-3">
            ...
            <p className="text-sm text-muted-foreground">
              The tool shows a before-and-after preview of the first few cues so
              you can sanity-check the shift. When it looks right, download the
              shifted SRT or VTT file. The filename includes the shift amount so
              you can tell copies apart.
            </p>
          </li>
        </ol>
      </section>
      ...
      <section className="pb-12">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed mb-4">
          The tool does the timestamp math. The harder question is figuring out
          how many seconds off the subtitles are in the first place. The fastest
          way is to pick a single line of dialogue near the start of the video,
          note the time at which the character actually speaks it, and compare
          that to the start time the subtitle file assigns to the same line.
        </p>
        <ul className="space-y-3 text-sm text-muted-foreground">
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0 w-48">
              Subtitles appear too late:
            </span>
            If dialogue is spoken at 00:12 but the caption appears at 00:14, the
            subtitles are 2 seconds behind the audio. Enter{' '}
            <span className="font-mono">-2</span> to pull them forward.
          </li>
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0 w-48">
              Subtitles appear too early:
            </span>
            If the caption shows at 00:10 but dialogue does not start until
            00:12, the subtitles are running 2 seconds ahead. Enter{' '}
            <span className="font-mono">+2</span> to delay them.
          </li>
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0 w-48">
              Fractional delays:
            </span>
            Small sync errors are often fractions of a second. Values like{' '}
            <span className="font-mono">0.3</span> or{' '}
            <span className="font-mono">-0.75</span> are fully supported. Enter
            values with up to millisecond precision.
          </li>
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0 w-48">
              Check at the end too:
            </span>
            If the shift that fixes the beginning does not also fix the end, the
            problem is probably not a pure shift. The first and last lines
            should both match after a correct shift — if only the first line
            syncs, the subtitles likely need FPS conversion instead.
          </li>
        </ul>
      </section>
      ...
      <section className="pb-12">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed mb-4">
          Subtitle sync issues have two common causes, and the right fix depends
          on which one you are dealing with. Using the wrong tool will make part
          of the file look right while another part still drifts.
        </p>
        <ul className="space-y-3 text-sm text-muted-foreground">
          <li className="flex gap-3">
            ...
            The subtitles are off by the same amount from start to finish — for
            example, consistently two seconds late through the whole video. A
            shift is the correct fix.
          </li>
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0 w-44">
              Growing drift:
            </span>
            The subtitles start close to correct but drift further off over
            time. The gap might be a few seconds at the end of a feature film
            for a small mismatch like 29.97 vs 30 fps, or close to four minutes
            for a larger one like 23.976 vs 25 fps. Either way it is a
            frame-rate mismatch, not a shift. Use the{' '}
            <Link
              href="/tools/subtitle-fps-converter"
              title="Rescale subtitle timing between frame rates"
          ...
          <li className="flex gap-3">
            ...
            If you have both a constant offset and frame-rate drift, run FPS
            conversion first to lock the pacing, then run a shift to align the
            absolute start time. Doing it in the other order still works but is
            harder to reason about because the shift value changes after
            rescaling.
          </li>
        </ul>
      </section>
        ...
        <ul className="space-y-3 text-sm text-muted-foreground">
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0">
              Different video cut than the subtitles were timed for:
            </span>
            Subtitles from one release sometimes carry over to a different cut
            of the same video with an intro or ad break of a different length. A
            single shift re-aligns the whole file.
          </li>
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0">
              Captions from a streaming source pulled into a local video player:
            </span>
            Streaming platforms sometimes embed a short pre-roll that the local
            file does not contain. A negative shift usually corrects the gap.
          </li>
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0">
              Re-encoded video with a slightly different start point:
            </span>
            Encoding a video with a trimmed opening can push subtitles a few
            seconds out of sync. A small shift, often under one second, restores
            alignment.
          </li>
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0">
              Manual sync to match dubbed audio:
            </span>
            Dubbed audio is often timed slightly differently from the original.
            A shift offers quick manual control when your dub and subtitles are
            close but not perfectly aligned.
          </li>
        </ul>
      </section>
      ...
      <section className="pb-12">
        ...
        <Accordion className="w-full">
          <AccordionItem value="how">
            ...
            <AccordionContent>
              Drop your SRT or VTT file into the tool, enter how many seconds
              off the subtitles are, and click shift. Positive values delay the
              subtitles; negative values pull them earlier. You can use decimals
              like 2.5 or -1.25 for fractional-second shifts.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="shift-vs-fps">
            <AccordionTrigger>
              What is the difference between shifting and FPS conversion?
            </AccordionTrigger>
            <AccordionContent>
              A shift adds or subtracts the same fixed amount to every cue. FPS
              conversion scales every cue by a ratio. Use a shift when subtitles
              are off by a constant amount from start to end. Use FPS conversion
              when subtitles start close to correct but drift further off as the
              video plays.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="negative">
            <AccordionTrigger>
              Does the tool support negative shifts?
            </AccordionTrigger>
            <AccordionContent>
              Yes. Enter a negative number to pull subtitles earlier. If any
              timestamp would go below zero, it is clamped to 00:00:00 and the
              tool shows a warning so you know which cues were affected.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="formats">
            ...
            <AccordionContent>
              The first version supports SRT (SubRip) and VTT (WebVTT). Support
              for ASS is on the roadmap because ASS karaoke and transition tags
              require additional timing logic.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="privacy">
            ...
            <AccordionContent>
              No. The timing shift runs entirely in your browser. Your subtitle
              file never leaves your device.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="find-value">
            <AccordionTrigger>
              What value should I enter to sync my subtitles?
            </AccordionTrigger>
            <AccordionContent>
              Play the video with the subtitles and note the delay at a specific
              cue. If the dialogue is spoken at 00:12 but the subtitle shows at
              00:14, subtitles are 2 seconds late — enter -2 to pull them
              earlier. If the subtitle shows at 00:10 but dialogue is at 00:12,
              subtitles are 2 seconds early — enter +2.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="original">
            <AccordionTrigger>
              Does the tool preserve my original file?
            </AccordionTrigger>
            <AccordionContent>
              Yes. The tool generates a new shifted file and leaves the original
              untouched. The download is named with the shift amount so you can
              tell shifted copies apart.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </section>
