...
const jsonLdData = toolPageJsonLd({
  ...
  faqs: [
    ...
    {
      question:
        'How do I know my subtitles need FPS conversion and not a shift?',
      answer:
    ...
    <div className="mx-auto max-w-4xl px-4 sm:px-6">
        ...
        <div className="mt-6 flex items-start gap-3 rounded-xl border border-blue-200 bg-blue-50/50 p-4">
          ...
          <div className="text-sm">
            ...
            <p className="text-muted-foreground mt-0.5">
              ...
              tool instead — FPS conversion is the wrong fix for a uniform
              delay.
            </p>
          </div>
        </div>
      ...
      <section className="pb-12 border-t pt-10">
        <h2 className="text-2xl font-bold mb-4">
          What Is Subtitle FPS Conversion?
        </h2>
        <p className="text-sm text-muted-foreground leading-relaxed mb-5">
          Subtitle FPS conversion rescales every subtitle timestamp by the ratio
          between the frame rate the subtitles were timed against and the frame
          rate of the video you are using now. It is the right fix for subtitles
          that start close to correct but drift further out of sync as the video
          plays.
        </p>
        <div className="rounded-xl border bg-card p-5 text-sm text-muted-foreground">
          <p className="font-medium text-foreground mb-2">Example</p>
          <p>
            In a <span className="font-mono">23.976 → 25</span> conversion,
            timestamps are multiplied by{' '}
            <span className="font-mono">23.976 / 25</span>. A cue at{' '}
            <span className="font-mono">00:10:00,000</span> becomes
            approximately <span className="font-mono">00:09:35,424</span>.
          </p>
        </div>
      </section>
        ...
        <ol className="grid gap-4 md:grid-cols-3 mb-8">
          <li className="rounded-lg border bg-card p-5">
            ...
            <p className="text-sm text-muted-foreground">
              Start with the subtitle file you need to rescale. The tool detects
              SRT and VTT automatically and runs the entire conversion locally
          ...
          <li className="rounded-lg border bg-card p-5">
            ...
            <p className="text-sm text-muted-foreground">
              Source FPS is the frame rate the subtitles were originally timed
              for. Target FPS is the frame rate of the video you are now
              playing. Common presets cover film, PAL, and NTSC rates; custom
          ...
          <li className="rounded-lg border bg-card p-5">
            ...
            <p className="text-sm text-muted-foreground">
              Review the before-and-after preview, then download the rescaled
              file. The output filename records the FPS conversion so you can
              tell rescaled copies apart from the original.
            </p>
          </li>
        </ol>
      </section>
      ...
      <section className="pb-12">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed mb-4">
          Subtitle timestamps are recorded in wall-clock hours, minutes,
          seconds, and milliseconds — not in frame numbers. But the person who
          timed them usually worked against a specific video cut. When the same
          subtitle file is played against a version of the video with a
          different frame rate, every cue drifts because the video is playing
          the dialogue at a slightly different pace.
        </p>
        <ul className="space-y-3 text-sm text-muted-foreground">
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0 w-52">
              23.976 ↔ 25 (film ↔ PAL):
            </span>
            Cinema film is typically 23.976 fps. European broadcast (PAL) is 25
            fps. Films released on PAL are sped up by about 4%, so subtitles
            timed for the cinema release drift further behind over a 90-minute
            film by nearly four minutes if played on a PAL transfer.
          </li>
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0 w-52">
              29.97 ↔ 30 (NTSC drift):
            </span>
            True 30 fps and 29.97 fps look identical to the eye but drift apart
            over long runtimes. The 0.1% difference compounds to several seconds
            over a feature film, which is enough to notice on the final act of a
            long movie.
          </li>
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0 w-52">
              23.976 ↔ 29.97 (telecine):
            </span>
            Film-to-NTSC conversions apply 3:2 pulldown. Subtitles timed for the
            theatrical release often need rescaling when paired with an NTSC
            broadcast or DVD copy.
          </li>
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0 w-52">
              High frame rate content:
            </span>
            HFR releases at 48, 50, or 60 fps need corresponding subtitle
            rescaling if the subtitle file comes from a standard-rate master.
          </li>
        </ul>
      </section>
      ...
      <section className="pb-12">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed mb-4">
          Every timestamp in the subtitle file is multiplied by the ratio of
          source to target FPS. If the source FPS is lower than the target, the
          ratio is less than one, which pulls cues earlier in the timeline. If
          the source is higher than the target, the ratio is greater than one
          and cues move later. The pattern below shows how a single timestamp
          moves during a 23.976 → 25 conversion.
        </p>
        <div className="rounded-xl border bg-card p-5 text-sm font-mono text-muted-foreground">
          ...
          <p>original 01:30:00,000 &rarr; rescaled 01:26:18,816</p>
        </div>
        <p className="text-sm text-muted-foreground leading-relaxed mt-4">
          Because the tool rescales every cue in one pass, both start and end
          times of every line stay internally consistent. No cue is stretched
          relative to another — the whole timeline just shifts to the new frame
          rate.
        </p>
      </section>
        ...
        <ul className="space-y-3 text-sm text-muted-foreground">
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0">
              Subtitles from a PAL release paired with an NTSC video:
            </span>
            European DVD rips often ship with 25 fps-timed subtitles that drift
            when paired with a 23.976 NTSC source. Convert 25 → 23.976 to
            realign them.
          </li>
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0">
              Cinema subtitle files paired with a broadcast cut:
            </span>
            A theatrical 23.976 fps subtitle file drifts against a PAL broadcast
            at 25 fps or an NTSC broadcast at 29.97 fps. Pick the appropriate
            pair to rescale.
          </li>
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0">
              Blu-ray remux with subtitles from a DVD:
            </span>
            DVD subtitles are often authored at 29.97 fps, and Blu-ray remuxes
            frequently play at 23.976 fps. The mismatch is a classic
            home-theater FPS conversion case.
          </li>
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0">
              Fan-provided subtitles for the wrong video source:
            </span>
            Community-created subtitle files often specify which video source
            they were timed for. If that does not match what you have, FPS
            conversion is usually the fix.
          </li>
        </ul>
      </section>
      ...
      <section className="pb-12">
        ...
        <Accordion className="w-full">
          <AccordionItem value="what-does">
            <AccordionTrigger>
              What does subtitle FPS conversion actually do?
            </AccordionTrigger>
            <AccordionContent>
              It rescales every timestamp in the subtitle file by the ratio of
              source to target FPS. A file timed for 23.976 fps but played
              against 25 fps drifts further off as the video progresses.
          ...
          <AccordionItem value="shift-or-fps">
            ...
            <AccordionContent>
              If the subtitles start close to correct but drift further out of
              sync over time, the problem is frame rate, not a fixed delay. If
              you can fix the first scene with a shift but the end still drifts,
              you need FPS conversion.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="which-fps">
            <AccordionTrigger>Which FPS values should I pick?</AccordionTrigger>
            <AccordionContent>
              Set Source FPS to the frame rate the subtitles were originally
              timed for, and Target FPS to the frame rate of the video you are
              now playing. The most common mismatches are 23.976 ↔ 25 (NTSC film
              vs PAL) and 29.97 ↔ 30.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="custom">
            <AccordionTrigger>
              What if my source or target FPS is unusual?
            </AccordionTrigger>
            <AccordionContent>
              Pick Custom from either dropdown and enter the exact value you
              need. The tool accepts decimals, so non-integer rates like 47.952
              or 119.88 work fine.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="formats">
            ...
            <AccordionContent>
              The first version supports SRT and VTT. ASS files are not yet
              supported because ASS karaoke and transition tags require
          ...
          <AccordionItem value="privacy">
            ...
            <AccordionContent>
              No. The FPS conversion runs entirely in your browser. Your file
              never leaves your device.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="shift-after">
            <AccordionTrigger>
              Do I need to shift subtitles after FPS conversion?
            </AccordionTrigger>
            <AccordionContent>
              Sometimes. If the file is both rescaled for the wrong frame rate
              and offset by a constant amount, run FPS conversion first to fix
              the pacing, then use the Subtitle Timing Shift tool to correct the
