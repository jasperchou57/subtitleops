...
const jsonLdData = toolPageJsonLd({
  ...
  faqs: [
    {
      question: 'Why convert SRT to ASS?',
      answer:
        'ASS supports rich styling, precise positioning, karaoke timing, and visual effects that SRT cannot represent. Converting gives you a starting point for adding those features in a subtitle editor like Aegisub.',
    },
    {
      question: 'Does the converter add styling to my subtitles?',
      answer:
        'The converter generates a default ASS style (Arial, 48px, white text with black outline). You can customize fonts, colors, positioning, and effects in any ASS-compatible editor after conversion.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Yes. The output is a valid ASS file with proper Script Info, V4+ Styles, and Events sections. Aegisub will open it directly and let you add styling, positioning, and effects.',
    },
    {
      question: 'Is my file uploaded anywhere?',
      answer:
        'No. The SRT to ASS conversion runs entirely in your browser. Your file never leaves your device.',
    },
    {
      question: 'What resolution does the converted ASS file use?',
      answer:
        'The default PlayResX is 1920 and PlayResY is 1080 (Full HD). You can change these values in Aegisub or any text editor if your video uses a different resolution.',
    },
  ],
});
    ...
    <div className="mx-auto max-w-4xl px-4 sm:px-6">
      ...
      <section className="pb-12 border-t pt-10">
        <h2 className="text-2xl font-bold mb-4">
          What Is an SRT to ASS Converter?
        </h2>
        <p className="text-sm text-muted-foreground leading-relaxed mb-5">
          An SRT to ASS converter turns plain SubRip subtitles into an Advanced
          SubStation Alpha subtitle file by preserving dialogue and timing,
          generating the required ASS script sections, and adding a default
          editable style. It does not invent advanced effects automatically; it
          creates a valid starting point for styling in an ASS editor.
        </p>
        ...
        <ol className="grid gap-4 md:grid-cols-3 mb-8">
          <li className="rounded-lg border bg-card p-5">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              with files from any transcription tool, editor, or platform.
            </p>
          </li>
          <li className="rounded-lg border bg-card p-5">
            <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-foreground text-background text-sm font-bold mb-3">
            ...
            <p className="text-sm text-muted-foreground">
              The converter creates [Script Info], [V4+ Styles], and [Events]
              sections with default styling. Timestamps are converted from SRT
              to ASS notation.
            </p>
          </li>
          <li className="rounded-lg border bg-card p-5">
            ...
            <p className="text-sm text-muted-foreground">
              Save the .ass file and open it in Aegisub or another ASS editor.
              From there you can add fonts, colors, positioning, karaoke timing,
              and effects.
            </p>
          </li>
        </ol>
      ...
      <section className="pb-12">
        ...
        <ul className="space-y-3 text-sm text-muted-foreground">
          <li className="flex gap-3">
            ...
            Contains metadata including ScriptType v4.00+, PlayRes of 1920x1080,
            and WrapStyle 0 (smart wrapping). These are sensible defaults for
            most video projects.
          </li>
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0 w-44">
            ...
            A single &ldquo;Default&rdquo; style using Arial 48px, white text
            with black outline (2px) and shadow (2px), bottom-center alignment.
            This is the standard starting point for ASS subtitle work.
          </li>
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0 w-44">
              [Events] section:
            </span>
            Each SRT entry becomes a Dialogue line with ASS-formatted timestamps
            (H:MM:SS.cc instead of HH:MM:SS,mmm). Multi-line SRT text is joined
          ...
          <li className="flex gap-3">
            ...
            SRT supports {`<b>`}, {`<i>`}, {`<u>`} tags. These are removed
            during conversion because ASS uses its own override tag system (
            {`{\\b1}`}, {`{\\i1}`}) which you can add in Aegisub.
          </li>
        </ul>
      </section>
        ...
        <ul className="space-y-3 text-sm text-muted-foreground">
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0">
              Fansub projects that need visual styling:
            </span>
            Anime fansubs, karaoke videos, and sign translations all require
            positioning and effects that SRT cannot provide. Converting to ASS
            is the first step before adding those visual layers.
          </li>
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0">
              Adding speaker identification with colors:
            </span>
            ASS lets you assign different styles to different speakers using
            named styles or inline color overrides. Start with the converted
            default style, then duplicate and customize per speaker.
          </li>
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0">
              Precise subtitle positioning:
            </span>
            When subtitles need to appear at specific screen positions to avoid
            overlapping signs, logos, or graphics, ASS provides pixel-level
            control that SRT does not have.
          </li>
          <li className="flex gap-3">
            <span className="font-medium text-foreground shrink-0">
              Building karaoke or lyric videos:
            </span>
            ASS supports syllable-level timing for karaoke effects. The
            converted file gives you the base timing from SRT, and you can add
            karaoke tags in Aegisub.
          </li>
        </ul>
      </section>
      ...
      <section className="pb-12">
        ...
        <ul className="space-y-2 text-sm text-muted-foreground">
          <li>
            ...
            explains the ASS override tags used for styling, positioning, and
            karaoke effects.
          </li>
          <li>
            <a
      ...
      <section className="pb-12">
        ...
        <Accordion className="w-full">
          <AccordionItem value="why-convert">
            ...
            <AccordionContent>
              ASS supports rich styling, precise positioning, karaoke timing,
              and visual effects that SRT cannot represent. Converting gives you
              a starting point for adding those features.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="styling">
            <AccordionTrigger>
              Does the converter add styling to my subtitles?
            </AccordionTrigger>
            <AccordionContent>
              The converter generates a default ASS style (Arial, 48px, white
              text with black outline). You can customize everything in an ASS
          ...
          <AccordionItem value="aegisub">
            <AccordionTrigger>
              Can I edit the ASS file in Aegisub?
            </AccordionTrigger>
            <AccordionContent>
              Yes. The output is a valid ASS file with proper Script Info, V4+
              Styles, and Events sections. Aegisub will open it directly.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="privacy">
            <AccordionTrigger>Is my file uploaded anywhere?</AccordionTrigger>
            <AccordionContent>
              No. The conversion runs entirely in your browser. Your file never
              leaves your device.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="resolution">
            <AccordionTrigger>
              What resolution does the converted ASS file use?
            </AccordionTrigger>
            <AccordionContent>
              The default PlayResX is 1920 and PlayResY is 1080 (Full HD). You
              can change these in Aegisub if your video uses a different
              resolution.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
