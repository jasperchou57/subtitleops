    ...
    <div className="mx-auto max-w-3xl px-4 sm:px-6 py-16">
      ...
      <div className="space-y-6 text-sm text-muted-foreground leading-relaxed">
        ...
        <p>
          ...
          subtitle timing correction through the Subtitle Timing Shift tool for
          fixing constant offsets, plus the Subtitle FPS Converter for rescaling
          between frame rates like 23.976, 25, 29.97, and 30 fps.
        </p>
        <p>
          More formats and tools are on our roadmap, including subtitle language
          translation. If a workflow you need is missing, send us a note —
          feature requests genuinely move the priority list.
        </p>
